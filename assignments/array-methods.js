...
console.log("BEGGINING OF ARRAY-METHODS SECTION==========");
...
let ticketPriceTotal = runners.reduce(function(accumulator, person){
...
// Problem 1
            ...
            //======== lists everyone numbe, first name, and email..

let nameAndEmail = [];

runners.map(function(person){
    nameAndEmail.push("runner number: " + person.id + ", name: " + person.first_name + ", email: " + person.email);
})
...
// Problem 2
            ...
            //======= input the company name to return a list of people within that company...

function worksAt (company){

   let newArr = runners.filter(function (person){
        return person.company_name === company;
    });

    return newArr;
}

console.log(worksAt("Gigashots"));
...
runners.forEach(function (person){
    return stolenMoney.push(person.donation += 10000000);
})
